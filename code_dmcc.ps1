...
#profile
$profile = Import-Csv -Path $sfdctbPath"profile.csv" -Encoding UTF8 | Select ID,NAME, PERMISSIONSRUNREPORTS, PERMISSIONSEXPORTREPORT, PERMISSIONSDATAEXPORT
...
$final = $total4 | Select NAME, PROFILENAME, ROLENAME, REPORTNAME, DESCRIPTION, REPORTID_r, PermissionsExportReport, PermissionsDataExport, timestamp | Sort-Object timestamp
$final | Export-Csv $outPath"DMCC_report_export_list.csv" -Encoding UTF8
...
$total8 | Export-Csv $outPath"DMCC_report_export_cnt_list.csv" -Encoding UTF8
